...
2. [애자일 개발론이란?](#p2)
3. [소프트웨어 라이센스란?](#p3)
4. [세마포어와 뮤텍스의 의미와 차이란?](#p4)
5. [교착상태는 언제 발생하나요?](#p5)
6. [가상기억장치의 의미는?](#p6)
7. [가상기억장치를 만드는 방법은?](#p7)
8. [페이징 기법과 세그멘테이션 기법은 무엇인가요?](#p8)
9. [레지스터의 의미는?](#p9)
10. [버스는 무엇인가요?](#p10)
11. [컴퓨터는 무엇으로 구성되있나요?](#p11)
12. [저장장치의 성능은 어떡해 표현될가요?](#p12)
13. [병렬시스템의 장점은?](#p13)
14. [운영체제란?](#p14)
15. [응집도와 결합도의 관계?](#p15)
16. [추상화란 무엇인가요?](#p16)
...
21. [다형성은 무엇인가요?](#p21)
22. [객체지향설계를 해보세요](#p22)
23. [객체지향은 어떤 원칙을 가져야하나요?](#p23)
24. [디자인패턴(싱글톤)에 대해 설명해보세요](#p24)
25. [디자인패턴(팩토리 메서드)에 대해 설명해보세요](#p25)
26. [운영체제란 무엇인가요?](#p26)
27. [형상관리에 대해 설명해보세요](#p27)
28. [빌드와 컴파일의 차이는?](#p28)
29. [MVC 패턴이란?](#p29)
30. [MVC 패턴에서 Model, View, Contoller의 역활은?](#p30)
31. [MVC 패턴에서 발생할 수 있는 실수들은?](#p31)
32. [MVC 패턴의 대안으로 나온 패턴과 차이는?](#p32)
33. [Layer](#p33)
---
...
#### p29
```
어플리케이션을 Model, View, Contoller 3가지 역활로 구분한 개발방법론이다.
```

---

## 30. MVC 패턴에서 Model, View, Contoller의 역활은?
#### p30
```
- Model은 데이터(값과 기능)를 가지고 있는 객체이다. (Model은 비즈니스 로직을 수행한다.)
- View는 Model의 포함된 데이터를 시각화한다. (View에는 비즈니스 로직이 포함되지않는다.)
- Controller는 view와 model 의 역활을 분리될 수 있도록, 데이터의 흐름을 제어한다.
```

---

## 31. MVC 패턴에서 발생할 수 있는 실수들, 불편함은?
#### p31
```
View에서 일어나는 '과한' 값 검증과 예외처리
View에서 일어나는 비즈니스 로직

view를 고칠때 컨트롤러도 같이 고치는 불편함
```

---

## 32. MVC 패턴의 대안으로 나온 패턴과 차이는?
#### p32
```
MVP 패턴(Presenter을 사용하여 뷰의 인터페이스와 결합)
MVVM 패턴(View가 ViewModel을 구독)
```
...
#### p33
```
Persistant Layer - (데이터 처리 - DAO 패턴)
Domain Model Layer - (DTO패)
```
...
[[10분 테코톡] 🐝범블비의 MVC Pattern](https://youtu.be/es1ckjHOzTI)